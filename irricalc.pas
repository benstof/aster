...
procedure Tbox.FormActivate(Sender: TObject);
begin
...
procedure Tbox.rflowClick(Sender: TObject);
var j : integer;
begin
   j:=1;
...
procedure Tbox.FormDeactivate(Sender: TObject);
var j : integer;
begin
   //pipeForm.visible:=false;
   with waarde do
...
procedure Tbox.iflowChange(Sender: TObject);
begin
   docalc;
end;

procedure Tbox.pres1Click(Sender: TObject);
begin
   panel1.visible:=pres1.checked;
   leninputChange(Sender);
end;

procedure Tbox.leninputChange(Sender: TObject);
begin
   diamresult.caption:='?';
   lenresult.caption:='?';
   egain.caption:='?';
...
procedure Tbox.BitBtn1Click(Sender: TObject);
...
procedure Tbox.pres3Click(Sender: TObject);
begin
   book1.pageindex:=2;
end;

procedure Tbox.book1Change(Sender: TObject; NewTab: Integer;
  var AllowChange: Boolean);
begin
   panel2.visible:=newtab=2;
end;

procedure Tbox.clpClick(Sender: TObject);
...
begin
   ...
   bm.canvas.copyrect(tr,box.canvas,tr1);  //tr1);
   clipboard.assign(bm);
   bm.free;
   clp.visible:=true;
   //hlp.visible:=true;
...
procedure Tbox.BitBtn2Click(Sender: TObject);
begin
...
procedure Tbox.HlpClick(Sender: TObject);
begin
   Application.HelpCommand(HELP_CONTEXT, (sender as tbitbtn).helpcontext);
end;

procedure Tbox.HelpBtnClick(Sender: TObject);
begin
   Application.HelpCommand(HELP_CONTEXT, (sender as tbitbtn).helpcontext);
end;
