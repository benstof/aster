...
begin
   ...
   if tcomp.ClassType=tradiogroup then
   begin
      if MMLang.getlang((tcomp as tradiogroup).Caption) then
         (tcomp as tradiogroup).caption:=MMLang.tx11;
      if MMLang.getlang((tcomp as tradiogroup).Hint) then
         (tcomp as tradiogroup).Hint:=MMLang.tx11;
   end;

   if tcomp.ClassType=ttabsheet then
   begin
      if MMLang.getlang((tcomp as ttabsheet).Caption) then
         (tcomp as ttabsheet).caption:=MMLang.tx11;
      if MMLang.getlang((tcomp as ttabsheet).Hint) then
         (tcomp as ttabsheet).Hint:=MMLang.tx11;
   end;
end;
